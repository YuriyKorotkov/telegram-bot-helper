...
file_attachments = {
    ...
    "object_card_1": os.path.join(BASE_DIR, "files",  "Заполнение_информации_об_объекте.pdf"),
    "add_contr_file": os.path.join(BASE_DIR, "files", "Добавление_контрактов_на_ПИР_и_СМР.pdf"),
